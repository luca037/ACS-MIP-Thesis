...
ma non consente di determinare se la soluzione trovata è la migliore possibile. % Cita https://www.ibm.com/docs/en/icos/22.1.1?topic=heuristics-what-are
L'obiettivo in questo caso non è quello di trovare una soluzione ottima ma di
ottenerne una ammissibile in poco tempo.
...
I problemi ausiliari vengono risolti utilizzando il B\&C.
...
% Sull'euristica posso usare la doc di cplex: https://www.ibm.com/docs/en/icos/22.1.1?topic=heuristics-what-are
Le implementazioni

% TODO: Piccola parte sugli algoritmi euristici. Devo trovare un documento.
