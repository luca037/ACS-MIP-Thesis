...
In generale gli euristici sono metodi che tentano di trovare una buona
soluzione impiegando poco tempo ed effettuando delle scelte basate su
alcune utili caratteristiche del problema considerato.
...
ottenerne una ammissibile di alta qualità e in poco tempo.
...
Sebbene possa essere utilizzato come algoritmo standalone,
l'ACS non viene proposto come algoritmo sostitutivo ai due introdotti
precedentemente ma come uno strumento aggiuntivo da integrare per velocizzare
il processo di risoluzione di un generico problema MIP.
L'implementazione allo stato dell'arte di B\&C \cite{cplex22.1.1} utilizza 
degli euristici per ottenere soluzioni utili per la dimostrazione di ottimalità.
L'utilizzo di questi metodi permette in molti casi di ottenere soluzioni
di alta qualità più velocemente rispetto a sfruttare solamente branching.
