...
\begin{algorithm}
    ...
    \begin{algorithmic}
        \Require Maximum number of iterations MAX\_ITR
        ...
        \For {$i\gets 1 \textbf{ to } MAX\_ITR$}
...
che si adatta a qualsiasi di struttura e permette di scegliere la quantità
...
Il parametro $\rho$ fornito in input permette di scegliere la quantità di variabili
da fissare.
Se viene raggiunta la fine di $I$ e non sono state fissate abbastanza variabili 
fissate, allora l'algoritmo fissa le variabili rimanenti partendo dall'inizio
di $I$ in modo circolare.
